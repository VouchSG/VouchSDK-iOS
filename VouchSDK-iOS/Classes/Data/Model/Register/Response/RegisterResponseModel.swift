...
public final class RegisterResponseModel: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    data = RegisterData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? RegisterData
