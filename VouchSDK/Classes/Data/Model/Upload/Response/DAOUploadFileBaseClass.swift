...
public final class DAOUploadFileBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var code: Int?
  public var data: DAOUploadFileData?
  ...
  public required init(json: JSON) {
    ...
    data = DAOUploadFileData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? DAOUploadFileData
